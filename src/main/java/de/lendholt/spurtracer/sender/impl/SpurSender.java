...
import de.lendholt.spurtracer.sender.ISpurSender;
...
public class SpurSender implements ISpurSender {
	...
	private Map<String, String> createBasicParameters(String host, String component, String context, String type)
		...
		if (host == null || host.isEmpty()) {
			throw new SpurFailureException("host must not be null");//$NON-NLS-1$
		}
		if (component == null || component.isEmpty()) {
			throw new SpurFailureException("component must not be null");//$NON-NLS-1$
		}
